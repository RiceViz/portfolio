...
export const PortfolioHub = () => {
  ...
  <div className="h-screen w-screen overflow-hidden absolute z-10 text-white animate-fade-in p-8 transition duration-150 ease-in-out">
      <div className="max-w-1/2 relative top-1/3 left-1/2 z-10 -translate-x-1/2 translate-y-1/4 text-center">
          ...
          <h2 className="text-3xl font-bold drop-shadow-[2px_2px_8px_rgba(255,255,255,0.4)]">Software Engineer & Game Developer</h2>
          <h2 className="text-3xl font-bold drop-shadow-[2px_2px_8px_rgba(255,255,255,0.4)]">Delaware, United States</h2>
      </div>
