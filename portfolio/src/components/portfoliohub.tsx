...
export const PortfolioHub = () => {
  ...
  <div className="h-screen w-screen overflow-hidden absolute z-10 text-white animate-fade-in p-8 transition duration-150 ease-in-out">
      {/*Title*/}
      <div className="lg:max-w-2/3 relative lg:top-2/7 lg:left-1/2 z-10 lg:-translate-x-1/2 lg:-translate-y-1/5 text-center">
      ...
      <div className="grid grid-cols-3 lg:-translate-y-32 lg:z-20 text-center text-5xl lg:text-9xl font-black">
        <div className="lg:absolute scale-50 lg:scale-25 lg:-translate-x-2/5 lg:-translate-y-2/5 transition delay-100 duration-150 ease-in-out  hover:scale-55 lg:hover:scale-30" 
        ...
        <div className="lg:absolute scale-50 lg:scale-30 lg:translate-x-3/8 lg:-translate-y-1/4 transition delay-100 duration-150 ease-in-out hover:scale-55 lg:hover:scale-35" 
        ...
        <div className="lg:absolute scale-50 lg:scale-25 lg:-translate-x-1/12 lg:-translate-y-[150px] transition delay-100 duration-150 ease-in-out hover:scale-55 lg:hover:scale-30" 
